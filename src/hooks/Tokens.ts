...
import { Token, currencyEquals, Currency, BASE_CURRENCY, ChainId } from '@enedex/sdk'
...
export function useCurrency(chainId: ChainId, currencyId: string | undefined): Currency | null | undefined {
  const isBase = Object.values(BASE_CURRENCY)
    .map((curr: Currency) => curr.symbol)
    .some(name => currencyId?.toUpperCase() === name)
