import { Currency, CurrencyAmount, BASE_CURRENCY, JSBI, Pair, Percent, Price, TokenAmount } from '@enedex/sdk'
  ...
  const dependentAmount: CurrencyAmount | undefined = useMemo(() => {
    if (noLiquidity) {
      ...
      if (tokenA && tokenB && wrappedIndependentAmount && pair) {
        ...
        return dependentCurrency === BASE_CURRENCY[chainId]
          ? CurrencyAmount.base(chainId, dependentTokenAmount.raw)
